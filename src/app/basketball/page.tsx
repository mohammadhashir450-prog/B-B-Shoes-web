        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          ...
          <div className="mb-16 text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">
              Basketball <span className="text-[#D4AF37]">Collection</span>
            </h1>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">Elevate your game with premium basketball footwear</p>
          </div>

          {loading ? (
            <div className="flex flex-col items-center justify-center py-20">
              <Loader2 className="w-12 h-12 text-[#D4AF37] animate-spin mb-4" />
              <p className="text-gray-400 text-sm">Loading basketball collection...</p>
            </div>
          ) : products.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 bg-gradient-to-br from-[#1A2435] to-[#0F1825] rounded-3xl border border-white/10">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">No Basketball Products Yet</h3>
                  ...
                  <div className="bg-gradient-to-br from-[#1A2435] to-[#0F1825] rounded-2xl overflow-hidden border border-white/5 hover:border-[#D4AF37]/50 transition-all duration-500 hover:shadow-2xl hover:shadow-[#D4AF37]/10">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center gap-1 mb-4">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} size={14} className={i < product.rating ? 'fill-[#D4AF37] text-[#D4AF37]' : 'fill-gray-600 text-gray-600'} />
                        ))}
