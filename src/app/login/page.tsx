          ...
          <div className="bg-[#0F1F35]/40 backdrop-blur-2xl rounded-3xl p-10 border border-white/10 shadow-2xl">
            ...
            <form onSubmit={handleSignIn} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input
                    ...
                    className="w-4 h-4 rounded border-white/20 bg-[#0B1829]/60 text-[#D4AF37] focus:ring-[#D4AF37] focus:ring-offset-0"
                  />
                  <span className="text-sm text-gray-400 group-hover:text-white transition-colors">
                    Stay Remembered
                  </span>
                </label>
                <Link href="/forgot-password" className="text-sm text-[#D4AF37] hover:text-white transition-colors">
                  Recovery Protocol
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#D4AF37] hover:bg-[#F4CE5C] text-black font-bold py-4 rounded-xl transition-all uppercase tracking-[0.15em] text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <button
                ...
                className="w-full border border-white/20 hover:border-[#D4AF37] text-white py-4 rounded-xl transition-all flex items-center justify-center gap-3 hover:bg-white/5"
              >
