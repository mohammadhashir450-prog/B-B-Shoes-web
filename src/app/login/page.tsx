...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white relative flex flex-col items-center justify-center overflow-hidden selection:bg-[#D4AF37]/25 selection:text-black">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] max-w-[800px] max-h-[800px] bg-[#D4AF37]/8 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[60vw] h-[60vw] max-w-[800px] max-h-[800px] bg-[#EDEFF3] blur-[120px] rounded-full pointer-events-none" />
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-black text-[#0B101E] leading-tight mb-2">
            Welcome <span className="text-transparent [-webkit-text-stroke:1px_rgba(11,16,30,0.35)]">Back</span>
          </h1>
        </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-5 relative z-10">
            ...
            <div className="flex items-center justify-between pt-2">
              <label className="flex items-center gap-3 cursor-pointer group">
                <div className="relative w-4 h-4 rounded border border-gray-300 bg-white flex items-center justify-center group-hover:border-[#A97A18] transition-colors">
                  <input
                    type="checkbox"
                    checked={rememberMe}
                ...
                <span className="text-xs text-[#0B101E]/70 group-hover:text-[#0B101E] transition-colors">
                  Remember me
                </span>
              </label>
              <Link href="/forgot-password" className="text-[10px] tracking-[0.1em] text-[#0B101E]/60 hover:text-[#A97A18] transition-colors uppercase font-bold">
                Forgot Password?
              </Link>
            </div>
        ...
        <div className="mt-8 text-center relative z-10">
          <p className="text-xs text-[#0B101E]/60">
            New to B&B?{' '}
            <Link href="/register" className="text-[#A97A18] hover:text-[#0B101E] font-bold tracking-wide transition-colors">
              Create an account
            </Link>
          </p>
        </div>
