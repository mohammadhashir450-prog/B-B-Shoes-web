                ...
                {regularProducts.map((product, index) => (
                  ...
                  >
                    <Link href={`/product/${product.id}`} className="h-full flex flex-col">
                      {/* Image Section */}
                      <div className="relative h-[195px] sm:h-[230px] lg:h-[245px] bg-[#FAF9F7] overflow-hidden p-3 rounded-xl border border-[#06080F]/45 shadow-[0_12px_24px_-18px_rgba(6,8,15,0.5)] transition-all duration-400 group-hover:border-[#06080F]/70 m-3">
                        <HoverSwapImage
