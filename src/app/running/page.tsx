        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-10 text-center pt-32 pb-20">
            ...
            <div className="inline-block mb-6">
              <span className="text-cyan-500 text-[10px] md:text-xs tracking-[0.3em] uppercase font-bold px-6 py-2 border border-cyan-500/30 rounded-full bg-cyan-500/5">
                THE 2024 COLLECTION
              </span>
            </div>
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 leading-tight">
              Velocity <span className="italic text-cyan-500" style={{fontFamily: 'Georgia, serif'}}>Unleashed.</span>
            </h1>

            {/* Subtitle */}
            <p className="text-gray-400 text-base md:text-lg max-w-3xl mx-auto leading-relaxed mb-12">
              Pure speed engineering. Maximum comfort. Zero compromises. Experience running redefined for the modern athlete.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <Link 
                href="#products"
                className="group px-10 py-4 bg-gradient-to-r from-cyan-500 to-cyan-400 text-white rounded-full font-bold text-sm uppercase tracking-wider hover:shadow-2xl hover:shadow-cyan-500/50 transition-all duration-300 flex items-center gap-2"
              >
                View Editorial
              ...
              <Link 
                href="#products"
                className="px-10 py-4 bg-transparent border-2 border-white/20 text-white rounded-full font-bold text-sm uppercase tracking-wider hover:bg-white/5 hover:border-cyan-500/50 transition-all duration-300"
              >
                Shop Collection
              </Link>
            </div>
            ...
            <div className="flex flex-col items-center gap-3">
              <ChevronRight size={20} className="text-cyan-500 rotate-90 animate-bounce" />
              <div className="flex gap-3">
                <button className="w-10 h-10 rounded-full bg-cyan-500 flex items-center justify-center hover:scale-110 transition-transform">
          ...
          <div className="max-w-[1400px] mx-auto px-6 md:px-10">
            ...
            <div className="flex items-end justify-between mb-12">
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-3">
                  Performance <span className="text-cyan-500">Running</span>
                </h2>
              ...
              <Link 
                href="/running" 
                className="hidden md:flex items-center gap-2 text-cyan-500 hover:text-cyan-400 transition-colors font-semibold"
              >
                View All Running 
                <ArrowRight size={18} />
              </Link>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-32 bg-gradient-to-br from-[#1A2435] to-[#0F1825] rounded-3xl border border-white/10">
                ...
                <p className="text-gray-400 text-lg mb-8">Our running collection is being curated</p>
                <Link 
                  href="/"
                  className="px-10 py-4 bg-gradient-to-r from-cyan-500 to-cyan-400 text-white rounded-full font-bold text-sm uppercase tracking-wider hover:shadow-2xl hover:shadow-cyan-500/50 transition-all duration-300"
                >
                  Browse All Products
                </Link>
              </div>
                  ...
                  >
                    ...
                    {product.isNewArrival && index === 0 && (
                      <div className="absolute -top-3 -left-3 z-20">
                        <span className="bg-cyan-500 text-white px-4 py-1.5 text-[9px] font-extrabold tracking-[0.2em] uppercase rounded-full shadow-xl">
                          NEW ARRIVAL
                        </span>
                      </div>
                    )}

                    <div className="bg-gradient-to-br from-gray-100 to-gray-50 rounded-3xl overflow-hidden hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 border border-transparent hover:border-cyan-500/30">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                          <div className="flex gap-3 w-full">
                            <button 
                              ...
                              className="flex-1 bg-cyan-500 text-white py-3 rounded-full font-bold text-sm hover:bg-cyan-400 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                            >
                              <ShoppingBag size={16} />
                            ...
                            >
                              <Heart 
                                size={18} 
                                className={isWishlisted(product.id) ? 'text-white fill-white' : 'text-white'}
                              />
                            </button>
                          </div>
                        </div>
                      ...
                      <div className="p-5 bg-gradient-to-br from-gray-800 to-gray-900">
                        {index === 0 && (
                          <p className="text-cyan-500 text-[9px] tracking-[0.25em] uppercase font-bold mb-2">
                            {product.brand || product.category}
                          </p>
                        )}
                        <h3 className="text-white font-bold text-lg mb-1 group-hover:text-cyan-500 transition-colors">
                          {product.name}
                        </h3>
                          ...
                          <button 
                            ...
                            className={`absolute top-5 right-5 w-9 h-9 backdrop-blur-sm rounded-full flex items-center justify-center transition-all shadow-lg group/btn ${
                              isWishlisted(product.id)
                                ...
                                : 'bg-white/90 hover:bg-cyan-500 hover:text-white'
                            }`}
                          >
                            <Heart 
                              size={16} 
          ...
          <div className="max-w-[1400px] mx-auto px-6 md:px-10">
            <div className="grid md:grid-cols-3 gap-12">
              ...
              <div className="text-center group">
                <div className="w-20 h-20 bg-gradient-to-br from-cyan-500 to-cyan-400 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-xl shadow-cyan-500/20">
