        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          ...
          <div className="mb-16 text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">
              Formal <span className="text-[#D4AF37]">Collection</span>
            </h1>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">Sophisticated elegance for every occasion</p>
          </div>

          {loading ? (
            <div className="flex flex-col items-center justify-center py-20">
              <Loader2 className="w-12 h-12 text-[#D4AF37] animate-spin mb-4" />
              <p className="text-gray-400 text-sm">Loading formal collection...</p>
            </div>
          ) : products.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 bg-gradient-to-br from-[#1A2435] to-[#0F1825] rounded-3xl border border-white/10">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">No Formal Products Yet</h3>
